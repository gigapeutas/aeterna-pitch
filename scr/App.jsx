...
function Pill({ children, color = "#00D2C8" }) {
  return (
    <span
      className="inline-block text-xs font-mono uppercase tracking-widest px-3 py-1 rounded-full border"
    ...
    >
      <div className="flex items-center gap-2">
        <div
          ...
          style={{ background: "linear-gradient(135deg,#00D2C8,#7C3AED)" }}
        >
      ...
      <a
        href="#captacao"
        className="hidden md:flex items-center gap-2 text-xs font-medium px-4 py-2 rounded-full border border-gray-700 text-gray-300 hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300"
      >
    ...
    <Section id="hero" className="min-h-screen flex flex-col justify-center pt-24 pb-24">
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10">
        <motion.div variants={fadeUp(0.1)} initial="hidden" animate="visible" className="mb-6">
          <Pill>Rodada Friends &amp; Family · 2025</Pill>
        </motion.div>
        ...
        <motion.h1
          ...
          style={{
            ...
            background: "linear-gradient(135deg, #FFFFFF 30%, #00D2C8 65%, #7C3AED 100%)",
        ...
        >
          ...
          >
            <span
              ...
              style={{ background: "linear-gradient(90deg,#7C3AED,#00D2C8)" }}
            />
            <span className="relative z-10">Participar da Rodada Friends &amp; Family</span>
          ...
          <a
            href="#arquitetura"
            className="inline-flex items-center gap-2 px-7 py-4 rounded-full font-medium text-gray-400 text-sm border border-gray-700 hover:border-gray-500 hover:text-white transition-all duration-300"
          >
            Ver Arquitetura
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            { value: "4", label: "Agentes Ativos", suffix: "+" },
...
function ProblemSolution() {
  ...
  const left = [
    "LLMs estáticos sem memória evolutiva",
    "Alucinações sem validação no mundo real",
    "Custo crescente de assinaturas proprietárias",
    "Dependência de um único modelo de IA",
    "Sem autonomia financeira ou operacional",
  ];

  const right = [
    "Enxame de Agentes com memória persistente",
    "Sandbox de validação: Zero Alucinação",
    "Custo Marginal Zero via APIs gratuitas",
    "Orquestração multi-modelo simultânea",
    "FinOps autônomo via cartão corporativo",
  ];
      ...
      <div ref={ref} className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl md:text-5xl font-black text-white tracking-tight">
            O Paradigma Está Quebrado.
          </h2>
          <p className="mt-3 text-gray-500 text-lg max-w-xl mx-auto">
            A indústria construiu ferramentas. A Aeterna constrói inteligência.
          </p>
        </motion.div>
            ...
            <GlassCard glowColor="rgba(239,68,68,0.05)">
              ...
              <ul className="space-y-4">
                {left.map((item, i) => (
                  ...
                  >
                    <span className="mt-1 text-red-500/60 flex-shrink-0">—</span>
                    {item}
                  </motion.li>
                ))}
              </ul>
...
const PILLARS = [
  ...
  },
  {
    ...
    label: "O Maestro",
    color: "#7C3AED",
    title: "Orquestração de Enxame",
    desc: "Divide tarefas complexas entre Agentes Especialistas. Groq para velocidade, Gemini para profundidade. Raciocínio paralelo com resultado unificado.",
    tag: "Núcleo de IA",
  },
  {
    icon: (
      ...
      <div ref={ref} className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl md:text-5xl font-black text-white tracking-tight max-w-2xl">
            Os 4 Pilares da<br />
            <span style={{ color: "#7C3AED" }}>Inteligência Distribuída</span>
          </h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {PILLARS.map((p, i) => (
            ...
            >
              <GlassCard
                glowColor={`${p.color}08`}
                className="group hover:border-gray-700 transition-colors duration-300 cursor-default h-full"
              >
                <div className="flex items-start justify-between mb-5">
                  ...
                  <span
                    ...
                    style={{ borderColor: `${p.color}30`, color: `${p.color}99`, background: `${p.color}08` }}
                  >
                    {p.tag}
                  </span>
                </div>
                <p className="text-xs font-mono uppercase tracking-widest mb-2" style={{ color: p.color }}>
                  {p.label}
                </p>
...
const PHASES = [
  {
    phase: "Fase 1",
    title: "Simbiose",
    subtitle: "Extração de APIs",
    color: "#00D2C8",
    status: "Em Execução",
    items: [
      "Integração Groq + Gemini como motores primários",
      "Orquestrador multi-agente funcional",
      "Sandbox de validação ativo (GitHub Actions)",
      "Memória persistente Supabase operacional",
    ],
  },
  {
    phase: "Fase 2",
    title: "Construção do",
    subtitle: "Dataset Dourado",
    color: "#7C3AED",
    status: "Q2 2025",
    items: [
      "Coleta de 10.000+ interações validadas",
      "Fine-tuning de modelos abertos (LLaMA 3, Mistral)",
      "Primeiros testes de modelo próprio",
      "Sistema FinOps via Stripe ativo",
    ],
  },
  {
    phase: "Fase 3",
    title: "Independência",
    subtitle: "Modelo Próprio",
    color: "#10B981",
    status: "Q4 2025",
    items: [
      "Desmame completo das APIs externas",
      "Modelo local auto-hospedado",
      "Receita autônoma cobrindo infraestrutura",
      "Soberania computacional total",
    ],
  },
];
      ...
      <div ref={ref} className="max-w-3xl mx-auto">
        ...
        <div className="relative">
          <div
            ...
            style={{ background: "linear-gradient(to bottom, #00D2C8, #7C3AED, #10B981)" }}
          />
            ...
            {PHASES.map((p, i) => (
              ...
              >
                <div className="flex-shrink-0 flex flex-col items-center">
                  <div
                    className="w-10 h-10 rounded-full border-2 flex items-center justify-center z-10 bg-black"
                  ...
                  <div className="flex items-start justify-between mb-4 flex-wrap gap-2">
                    <div>
                      ...
                      <h3 className="text-xl font-black text-white leading-tight">
                        {p.title}<br />
                        <span style={{ color: p.color }}>{p.subtitle}</span>
                      </h3>
                    </div>
                    <span
    ...
    <Section id="captacao" className="py-32">
      <div ref={ref} className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div
            className="relative rounded-3xl border border-gray-800 p-8 md:p-14 text-center overflow-hidden"
            style={{
          ...
          >
            <motion.div variants={fadeUp(0.1)} initial="hidden" animate={inView ? "visible" : "hidden"}>
              <Pill>Rodada Friends &amp; Family · Aberta</Pill>
            </motion.div>
            ...
            <motion.h2
              ...
              initial="hidden"
              animate={inView ? "visible" : "hidden"}
              className="mt-6 text-3xl md:text-5xl font-black text-white tracking-tight leading-tight"
            >
              Este é o Momento<br />
              da <span style={{ color: "#00D2C8" }}>Fundação</span>.
            </motion.h2>
            ...
            <motion.div
              ...
              initial="hidden"
              animate={inView ? "visible" : "hidden"}
              className="mt-8 max-w-2xl mx-auto text-left space-y-5 text-gray-400 text-base leading-relaxed"
            >
              <p>
                A Aeterna.ia não está em busca de capital de risco institucional. Ainda. Este é o convite
                para os que <span className="text-white font-medium">acreditam antes de todos os outros</span> — família,
                amigos e aliados que entendem que grandes construções começam com pessoas, não com planilhas.
              </p>
              <p>
                O investimento desta rodada garantirá o <span className="text-white font-medium">runway operacional</span> para
                que o engenheiro-chefe dedique 100% do seu tempo à arquitetura — sem distrações, sem compromissos
                paralelos — até o momento em que a própria Aeterna gerar sua primeira receita autônoma.
              </p>
              <p>
                Não estamos vendendo um produto. Estamos construindo um{" "}
                <span className="text-white font-medium">precedente</span>: a primeira entidade digital
                que aprende, valida, evolui e se financia de forma independente. Quem entrar agora entra na história.
              </p>
            </motion.div>
            ...
            >
              {[
                ...
                { label: "Retorno Projetado", value: "Fase 3 →", sub: "Receita autônoma da IA" },
                { label: "Acesso", value: "Fundadores", sub: "Participação na jornada" },
              ].map((item) => (
                <div
                  key={item.label}
                  className="rounded-2xl border border-gray-800 p-5 text-left"
            ...
            >
              <a
                href="mailto:contato@aeterna.ia"
    ...
    <footer className="relative z-10 py-10 px-6 md:px-12 lg:px-24 border-t border-gray-900">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-5">
          {["Arquitetura", "Roadmap", "Captação"].map((l) => (
            <a
              key={l}
              href={`#${l.toLowerCase()}`}
...
export default function App() {
  return (
    <div
      ...
      style={{ background: "#000000", fontFamily: "'DM Sans', 'Inter', sans-serif" }}
    >
      <style>{`
